...
const Carrito = () => {
  const { cart, addToCart, removeFromCart, total } = useContext(ProductosContext);
  ...
  return (
    <div className="container mt-5">
            ...
            <div key={index} className="carrito-item py-3 border-bottom">
              <div className="d-flex align-items-center">
                ...
                <div className="flex-grow-1">
                  ...
                  <p className="card-text mb-1">Cantidad: {game.quantity}</p>
                </div>
                <div className="d-flex align-items-center">
                  <button
      ...
      <div className="total-container mt-4 text-end">
        <h3>Total: ${formatoNumero(total)}</h3>
